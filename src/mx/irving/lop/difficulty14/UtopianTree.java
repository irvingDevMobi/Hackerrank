package mx.irving.lop.difficulty14;

/**
 * Created by Irving Lop on 05/12/2015.
 *  Problem Statement
 ...
 Laura plants a Utopian Tree sapling with a height of 1 meter at the onset of spring. How tall will her
 ...
 For each test case, print the height of the Utopian Tree after N cycles. Each height must be printed
 on a new line.
...
public class UtopianTree {
    ...
    public int height() {
        return height(mCycles);
    }

    public static int height(int cycles) {
        int height = 1;
